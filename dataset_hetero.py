...
# train_dataset = GNNC21Dataset(root='data/GNN-CH21/', filename='gnnet-ch21-dataset-validation', val=True)
...
if __name__ == '__main__':
    train_dataset = GNNC21Dataset(
        root='data/GNN-CH21-H/', filename='gnnet-ch21-dataset-train')
    val_dataset = GNNC21Dataset(
        root='data/GNN-CH21-H/', filename='gnnet-ch21-dataset-validation', val=True)
    test_dataset = GNNC21Dataset(
        root='data/GNN-CH21-H/', filename='gnnet-ch21-dataset-test-with-labels', test=True)
    pass
